...
public class MainPage {
    ...
    public void clickUsernameLabel() {
        wait.until(ExpectedConditions.visibilityOf(usernameLinkInNavBar));
        usernameLinkInNavBar.click();
    }

    public void clickProfileLink() {
        wait.until(ExpectedConditions.visibilityOf(profileLinkInNavBar));
        profileLinkInNavBar.click();
    }
